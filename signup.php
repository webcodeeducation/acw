...
<head>
    ...
    <title>Signup at Allcondigworld - All code at once place</title>
...
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">First Name
</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Last Name
</label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="lastname" name="email" type="email" placeholder="Email" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Password
</label>  
  <div class="col-md-4">
  <input id="password" name="passwrd" type="passwrd" placeholder="Password" class="form-control input-md">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Gender
</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput">Date of Birth
</label>  
  <div class="col-md-4">
...
<div class="form-group">
  ...
  <div class="col-md-4">
  <input id="contactno" name="contactno" type="text" placeholder="Mobile no" class="form-control input-md">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea">User introduction</label>
  <div class="col-md-4">                     
    <textarea class="form-control" id="userintro" name="userintro">Enter introduction</textarea>
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <input id="userimage" class="form-control" name="userimage" class="input-file" type="file">
  </div>
</div>
...
<div class="form-group">
  ...
  <div class="col-md-4">
    <button type="button" class="btn btn-primary usersubmit">Submit</button>
  </div>
</div>
    ...
    <script src="js/jquery.js"></script>
	    <!-- Do not edit these files! In order to set the email address and subject line for the contact form file. -->
